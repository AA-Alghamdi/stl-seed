...
def test_topology_aware_repressilator_satisfies() -> None:
    ...
    This is the regression test for the topology-aware policy: under the
    previous bang-bang policy ρ was -247 (catastrophic miss); under the
    topology-aware policy ρ should be ~ +25.
    """
