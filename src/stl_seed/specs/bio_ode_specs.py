...
rather than transcribed (source-isolation protocol).
"""
...
repressilator_spec = STLSpec(
    ...
    metadata={
        ...
        "allowed_form": "conjunction of tracking + reachability",
    },
)
...
toggle_spec = STLSpec(
    ...
    metadata={
        ...
        "allowed_form": "conjunction of tracking + avoidance",
    },
)
...
mapk_spec = STLSpec(
    ...
    formula=And(
        children=(
            ...
            # horizon. Predicate-level negation is allowed (conjunction-only):
    ...
    metadata={
        ...
        "allowed_form": ("conjunction of reachability + tracking + avoidance"),
    },
)
register(mapk_spec)
