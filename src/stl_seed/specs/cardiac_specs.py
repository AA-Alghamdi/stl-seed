...
Conjunction-only structure: every formula in this module is
...
incidental rather than transcribed (source-isolation protocol).
"""
...
# textbook calibration band per the conjunction-only conjunction-only
# allowed form.
...
depolarize_spec = STLSpec(
    ...
    metadata={
        ...
        "allowed_form": "single reachability clause",
    },
)
...
train_spec = STLSpec(
    ...
    metadata={
        ...
        "control_points": 10,
        "thresholds_dimensionless": {"V_PEAK": V_PEAK},
        "allowed_form": "conjunction of two reachability clauses",
    },
)
register(train_spec)
...
suppress_after_two_spec = STLSpec(
    ...
    metadata={
        ...
        "allowed_form": ("conjunction of two reachability + one tracking clause"),
    },
)
