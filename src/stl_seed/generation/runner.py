...
# -----------------------------------------------------------------------------
# The package also provides a stand-alone `stl_seed.stl.evaluator` module.
# The runner keeps a self-contained NumPy reference implementation of
# Donzé-Maler ρ over the AST defined in `stl_seed.specs`; the two
# implementations must agree to within float64 epsilon when both are present.
# -----------------------------------------------------------------------------
