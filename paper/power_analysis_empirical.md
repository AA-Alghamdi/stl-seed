        ...
        *Date: 2026-04-24. Companion to paper/theory.md §5.*
        ...
        |------|--------|---:|-----:|----:|----:|----:|
| `bio_ode.repressilator` | `heuristic` | 1,000 | -2.488e+02 | 0.000e+00 | -2.488e+02 | -2.488e+02 |
| `bio_ode.repressilator` | `random` | 982 | -2.455e+02 | 4.565e+00 | -2.487e+02 | -2.040e+02 |
| `glucose_insulin` | `heuristic` | 1,000 | +2.075e+01 | 0.000e+00 | +2.075e+01 | +2.075e+01 |
| `glucose_insulin` | `random` | 1,000 | -1.129e+00 | 3.408e+00 | -1.042e+01 | +1.051e+01 |
