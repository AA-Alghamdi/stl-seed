...
`stl-seed` is a single-author research artifact. This file documents the development workflow and the two extension paths a reviewer or external researcher is most likely to need.
