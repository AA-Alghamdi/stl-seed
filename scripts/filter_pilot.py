"""Apply the three STL filter conditions to the pilot trajectory store.
...
def main() -> int:
    console.rule("[bold]Apply STL filter conditions to pilot store")
    ...
    # but they do not mark the script as "failed". The script's contract is to
